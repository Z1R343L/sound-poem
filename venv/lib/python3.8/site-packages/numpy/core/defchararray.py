...
def _get_num_chars(a):
    ...
    """
    return a.itemsize // 4 if issubclass(a.dtype.type, unicode_) else a.itemsize
...
class chararray(ndarray):
    ...
    """
    def __new__(cls, shape, itemsize=1, unicode=False, buffer=None, offset=0, strides=None, order='C'):
        global _globalvar
