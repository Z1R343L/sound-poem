...
def generate_api(output_dir, force=False):
    ...
    d_file = os.path.join(output_dir, f'{basename}.txt')
...
def do_generate_api(targets, sources):
    ...
    if len(multiarray_api_dict) != len(multiarray_api_index):
        ...
        raise AssertionError(
            f"Multiarray API size mismatch - index has extra keys {keys_index - keys_dict}, dict has extra keys {keys_dict - keys_index}"
        )
