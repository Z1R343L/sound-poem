...
class TestDateTime:
    ...
    def test_dtype_promotion(self):
        ...
        for mM in ['m', 'M']:
            assert_equal(
                np.promote_types(np.dtype(f'{mM}8[2Y]'), np.dtype(f'{mM}8[2Y]')),
                np.dtype(f'{mM}8[2Y]'),
            )

            assert_equal(
                np.promote_types(np.dtype(f'{mM}8[12Y]'), np.dtype(f'{mM}8[15Y]')),
                np.dtype(f'{mM}8[3Y]'),
            )

            assert_equal(
                np.promote_types(np.dtype(f'{mM}8[62M]'), np.dtype(f'{mM}8[24M]')),
                np.dtype(f'{mM}8[2M]'),
            )

            assert_equal(
                np.promote_types(np.dtype(f'{mM}8[1W]'), np.dtype(f'{mM}8[2D]')),
                np.dtype(f'{mM}8[1D]'),
            )

            assert_equal(
                np.promote_types(np.dtype(f'{mM}8[W]'), np.dtype(f'{mM}8[13s]')),
                np.dtype(f'{mM}8[s]'),
            )

            assert_equal(
                np.promote_types(np.dtype(f'{mM}8[13W]'), np.dtype(f'{mM}8[49s]')),
                np.dtype(f'{mM}8[7s]'),
            )
